...
class ActYiMing extends \Prj\Bll\ActRuleZy\_ActRuleBase
{
    protected $activityTypes = 'famous';

    protected function getActCode(){
        return \Prj\Model\Activity::yiming_code;
    }
    ...
    protected function getAmount($params = []){
        ...
        $orderInfo = \Prj\Model\ZyBusiness\TradOrder::getMaxByPrdId($productId);
