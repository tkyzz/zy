...
class Banner extends \Prj\Model\_ModelBase
{
    ...
    protected function onInit()
    {
        ...
        $this->_tbName = 'tb_manage_banner';//表名的默认模板
    }
    ...
    public static function getBannerOid(){
        $oid=md5(microtime(true).rand(10000,99999));
        return $oid;
    }

    public static function getBannerCount(){
        $count=static::db()->getRecordCount(static::tb());
        return $count;
    }

    public static function getBannerReleaseCount(){
