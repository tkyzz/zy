 ...
 * By Hand
 */
class OneChuiController extends \Rpt\Manage\ManageIniCtrl
{
    ...
    public function pageupdAction()
    {
        ...
        $edtForm->appendHiddenFirst('__pkey__', $strpkey)
            ...
            ->addFormItem(\Sooh2\BJUI\FormItem\Text::factory('nickname', $obj->getField('nickname'),'昵称')->initChecker(new \Sooh2\Valid\Str(true,1,4)))
...
//            ->addFormItem(\Sooh2\BJUI\FormItem\Text::factory('nickname', '','昵称')->initChecker(new \Sooh2\Valid\Str(true)));
        $edtForm->addFormItem(\Sooh2\BJUI\FormItem\Text::factory('eventId', '','活动ID')->initChecker(new \Sooh2\Valid\Str(true)))
            ->addFormItem(\Sooh2\BJUI\FormItem\Textarea::factory('coupon', '','规则')->initChecker(new \Sooh2\Valid\Str(true)))
            ->addFormItem(\Sooh2\BJUI\FormItem\Text::factory('name', '','红包名称')->initChecker(new \Sooh2\Valid\Str(true)))
            ->addFormItem(\Sooh2\BJUI\FormItem\Text::factory('desc', '','红包描述')->initChecker(new \Sooh2\Valid\Str(true)))
            ;
